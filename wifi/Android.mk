...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi-service-lazy.selene.rc
...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi-service-lazy.selene
...
LOCAL_REQUIRED_MODULES := \
    android.hardware.wifi-service-lazy.selene.rc \
